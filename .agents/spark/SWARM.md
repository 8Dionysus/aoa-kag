...
- Каждый lane заканчивает как `done` или `handoff`, без зависимости от
  in-session переключения на большую модель.
...
4. done signal or handoff condition
5. provenance and anti-overbuild risks
```
