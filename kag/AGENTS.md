...
| `indexes/` | canonical source, artifact, anchor, entity, event, assertion, relation, and owner-domain index records |
| `projections/` | MCP/resource-facing compact views |
| `receipts/` | validation and freshness receipts |

The repo-self family follows the source and repository index schemas, is
regenerated by `scripts/generate_repo_local_kag_index.py`, and is read through
