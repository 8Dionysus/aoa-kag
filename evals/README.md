...
This skeleton `evals/` port preserves KAG-born eval pressure such as retrieval
readiness cases, projection health fixtures, source-trace questions, lifted
surface checks, and regrounding review cues.
