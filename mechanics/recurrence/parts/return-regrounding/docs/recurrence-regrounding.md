...
This document records the recurrence-law activation for `aoa-kag`.
...
The concrete activation for this posture is one generated pack:

- `mechanics/recurrence/parts/return-regrounding/schemas/return-regrounding-pack-manifest.schema.json`
...
## What this regrounding scope does not do

This regrounding scope does not:
