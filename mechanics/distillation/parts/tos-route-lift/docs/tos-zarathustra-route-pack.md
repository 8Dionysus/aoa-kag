...
This route scope does not derive from:
...
- `mechanics/distillation/parts/tos-route-lift/schemas/tos-zarathustra-route-pack-manifest.schema.json`
- `mechanics/distillation/parts/tos-route-lift/schemas/tos-zarathustra-route-pack.schema.json`
...
## What this route scope does not do

This route scope does not:
