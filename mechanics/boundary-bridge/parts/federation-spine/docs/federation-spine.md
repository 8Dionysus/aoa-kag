...
This spine scope is intentionally narrow:

- materialize one reviewable federation spine surface
- keep the activation entirely inside `aoa-kag` as a derived spine
...
`mechanics/boundary-bridge/parts/source-owned-export/manifests/federation_export_registry.json`.
The live two-repo contour remains declared in `mechanics/boundary-bridge/parts/federation-spine/manifests/federation_spine.json`.
The current external export expectations are made explicit in
`mechanics/boundary-bridge/parts/source-owned-export/manifests/source_owned_export_dependencies.json` and documented in
...
this live spine yet.
Its memory readiness boundary note remains a memo-owned owner-boundary ref for
