...
This document records the current bounded counterpart-edge posture at the KAG layer.

It complements [BRIDGE_CONTRACTS](../../../../../docs/BRIDGE_CONTRACTS.md).
...
- the first downstream consumer contract now exists at `mechanics/boundary-bridge/parts/counterpart-edge/docs/counterpart-consumer-contract.md`
...
- a dedicated downstream consumer contract now exists at `mechanics/boundary-bridge/parts/counterpart-edge/docs/counterpart-consumer-contract.md`
- federation exposure is now explicitly reviewed through `mechanics/audit/parts/exposure-review/docs/counterpart-federation-exposure-review.md` and `mechanics/audit/parts/exposure-review/generated/counterpart_federation_exposure_review.min.json`

Promotion is still deferred:

- moving `AOA-K-0008` to `experimental` requires a separate activation pass with its own generated surface and promotion review
