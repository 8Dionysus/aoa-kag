...
- `mechanics/boundary-bridge/parts/counterpart-edge/schemas/counterpart-edge-surface.schema.json`
- `mechanics/boundary-bridge/parts/counterpart-edge/examples/counterpart_edge_view.example.json`

## Allowed return posture

When `counterpart_refs` are returned in the current planned scope, they may point only to
...
- no generated `AOA-K-0008` payload in this planned scope
