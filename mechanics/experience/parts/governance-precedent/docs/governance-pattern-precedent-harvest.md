# Governance Pattern Precedent Harvest

Status: active candidate contract v0.8.0
Repo route: `aoa-kag`
Layer: Experience Polis Governance

## Purpose

Harvesting stable governance decisions into derived precedent patterns.

v0.8 adds a polis-governance contour around the experience mechanic. Earlier experience cycles forged capture, distillation, certification, deployment, federation and adoption. This contract asks a harder question: **who may decide when those paths conflict?**
...
- aoa-kag receives only bounded governance surfaces.
