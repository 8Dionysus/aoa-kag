...
ESCAPE_VALUE = "__office_service_pattern_not_allowed__"

OFFICE_SERVICE_PATTERN_CONTRACTS = (
    ('multi_office_train_precedent_v1', 'multi_office_train_precedent_v1.json'),
    ('office_service_pattern_candidate_v1', 'office_service_pattern_candidate_v1.json'),
)
...
class OfficeServicePatternContractTests(unittest.TestCase):
    ...
    def test_office_service_pattern_examples_match_schemas(self) -> None:
        self.assertTrue(OFFICE_SERVICE_PATTERN_CONTRACTS)
        missing_pairs: list[str] = []
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema_path = PART_ROOT / "schemas" / schema_file
            example_path = PART_ROOT / "examples" / f"{stem}.example.json"
        ...
        self.assertFalse(missing_pairs, "missing office-service-pattern contract pair(s): " + ", ".join(missing_pairs))
    ...
    def test_office_service_pattern_schemas_reject_unknown_fields(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_wrong_types_for_every_field(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_missing_required_fields(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_bad_array_items(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_empty_strings(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_const_escapes(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_enum_escapes(self) -> None:
        exercised = 0
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
    ...
    def test_office_service_pattern_schemas_reject_numeric_bound_escapes(self) -> None:
        for stem, schema_file in OFFICE_SERVICE_PATTERN_CONTRACTS:
            schema, example = load_contract(stem, schema_file)
            for path, value in walk_values(example):
