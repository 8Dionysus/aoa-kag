...
This handoff scope is intentionally narrow:
...
- `mechanics/checkpoint/parts/reasoning-handoff/docs/reasoning-handoff.md` in `aoa-kag`
...
Those inputs are declared in `mechanics/checkpoint/parts/reasoning-handoff/manifests/reasoning_handoff_pack.json`.
