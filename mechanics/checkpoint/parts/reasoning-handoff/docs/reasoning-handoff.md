...
`mechanics/recurrence/parts/return-regrounding/generated/return_regrounding_pack.min.json` rather than a wider KAG-authored
continuation.
...
When `counterpart_refs` are returned in the current planned scope, they must stay
