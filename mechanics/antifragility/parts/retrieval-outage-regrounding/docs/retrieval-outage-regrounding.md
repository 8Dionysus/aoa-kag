# Retrieval Outage Regrounding

This route maps the retrieval-outage honesty family into
`aoa-kag`.
...
The generic outage family is mapped onto the real neighboring surfaces that
...
This route therefore makes source-first recovery more legible without
pretending that KAG now owns runtime repair or verdict logic.
