# KAG PATTERN NODE CANDIDATE

## Purpose

Candidate shape for KAG nodes created from federation harvest.
...
- aoa-kag v0.6 surface
- explicit inputs and outputs
- reviewable artifacts and gates
- owner-local placement hints where applicable
...
- routing owner-placement receipts

## Outputs

- reviewable candidate records
- owner-local placement hints
- gate decisions
- derived summaries
...
- no new aoa-experience repo; federation harvest is a center-owned program with owner-local adoption routes
