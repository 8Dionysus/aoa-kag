# Agon Sophian Kag Packet Bridge

KAG prepares derived-substrate packets for Sophian threshold review without becoming canon.
...
For the active payload contract, use [`../CONTRACT.md`](../CONTRACT.md).
