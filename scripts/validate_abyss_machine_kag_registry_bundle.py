...
DEFAULT_BUNDLE_DIR = REPO_ROOT / "dist" / "abyss-artifact-bundle" / "aoa-kag-registry-readmodel"
DEFAULT_REGISTRY_DIR = REPO_ROOT / "dist" / "abyss-artifact-registry" / "aoa-kag-registry-readmodel"
DEFAULT_SUBJECT_STORE_ROOT = REPO_ROOT / "dist" / "abyss-artifact-subjects" / "aoa-kag-registry-readmodel"
ARTIFACT_CLASS = "derived_kag_registry_readmodel_bundle"
OWNER_REPO = "aoa-kag"
CONSUMER_INTENT = "agent"
CONSUMER_REF = "aoa-kag:kag-registry"
TRUST_ROOT_MODE = "host_managed"
PRODUCER = "aoa-kag registry readmodel builder"
    ...
    *,
    ...
    try:
        ...
        if require_abyss_machine:
            raise
        return _validate_portable_contract(
            manifest,
            subject,
            bundle_dir,
            registry_dir,
