...
WAVE3_STEMS = (
    "kag_adoption_boundary_guard",
    "kag_adoption_dossier",
    "kag_federation_lineage_link",
    "kag_owner_signal",
    "kag_pattern_candidate",
    "kag_pattern_downlink",
    "kag_pattern_node",
    "kag_pattern_retirement_decision",
    "kag_pattern_retirement_signal",
    "kag_promotion_evidence_bundle",
    "kag_to_tos_dossier_bridge",
)
