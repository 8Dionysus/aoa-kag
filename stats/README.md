...
| `aoa-kag/owner-local-pr-workflow-wall-time` | What wall time do real hosted owner-local PR workflows require while both local proofs remain blocking? | `188 s` median, `n=3`, workflow blob `41372d185b9ca250b110faf5421d975db8d0c805` |
